...
#define device_id "team4-light" //Device ID
...
void RecvMessage (int packetSize){
  ...
  if(packetSize){
    ...
    String team4 = packetBuffer;

    if(team4.compareTo("Team4Bright") == 0 )
    {
      Serial.println("   - Bright (From team4)");
    }
    if(team4.compareTo("Team4Dark") == 0 )
    {
      Serial.println("   - Dark (From team3)");
    }
